...
def concat_data_and_load_temp(**kwargs):
    ...
    df.to_parquet(
        f"/datalake/bronze/bronze_elipse_performance/bronze_elipse_performance{data_hora_atual}_FULL_{data_inicio_formatado}_{data_fim_formatado}.parquet", index=False
    )
...
with DAG(
    ...
    trigger_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="GOLD_F_PERFORMANCE_SIMON_FULL",  # Nome da DAG a ser acionada
    )
