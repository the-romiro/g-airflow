...
where q.data_hora between '{{ params.data_inicio }}' and '{{ params.data_fim }}'
)
...
when not matched by target then
	...
	when not matched by source and q.data_hora between '{{ params.data_inicio }}' and '{{ params.data_fim }}' then
	delete;
